...
```{r}
# Only two segments in a row.
gpt3 = read.csv("../data/model_output/gpt3_output.txt") %>%
  mutate(logprob = if_else( (!is.na(line) & is.na(logprob)), 0, logprob),
  ...
  mutate(
    logprob = if_else(is_seg_2 & is_seg_1, logprob + surp_2, logprob),
    token = if_else(is_seg_2 & is_seg_1, paste(token, seg_2, sep=""), token)
  ) %>%
  filter(segment == F) %>%
...
df = merge(df_base, gpt3, by=c("sent", "token", "word_idx"), all=T) %>%
  select(-sent_index.x, -sent_index.y, -line, -sent) %>%
  mutate(GPT3 = if_else(is.na(GPT3), 0, GPT3))

# Check to make sure we have data in all the relevant items / condtiions (esp. for GPT3)
df %>%
...
ggplot(aes(x=test, y=m, ymin=lower, ymax=upper, fill=gap)) +
    ...
    theme(legend.position="right", 
          ...
          axis.title=element_text(size=12),
          legend.title=element_blank())
#ggsave("./images/unboundedness.pdf",height=4,width=10, , device = cairo_pdf)
...
ggplot(aes(x=test, y=m, ymin=lower, ymax=upper, fill=gap)) +
    ...
    theme(legend.position="right", 
          ...
          axis.title=element_text(size=12),
          legend.title=element_blank())
#ggsave("./images/heirarchy.pdf",height=4,width=10, device = cairo_pdf)
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
   theme_bw() +
    ...
    theme(legend.position="right", 
          ...
          legend.title=element_blank())
#ggsave("./images/adjunct.pdf",height=2.8,width=10, device = cairo_pdf)
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
   theme_bw() +
    ...
    theme(legend.position="right", 
          ...
          axis.title.x=element_blank(),
          legend.title=element_blank())
#ggsave("./images/cnp.pdf",height=2.8,width=10, device = cairo_pdf)
```
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
   theme_bw() +
    ...
    theme(legend.position="right", 
          ...
          axis.title.x=element_blank(),
          legend.title=element_blank())
#ggsave("./images/coord.pdf",height=2.8,width=10, device = cairo_pdf)
```
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
   theme_bw() +
    ...
    theme(legend.position="right", 
          ...
          axis.title.x=element_blank(),
          legend.title=element_blank())
#ggsave("./images/left-branch.pdf",height=2.8,width=10, device = cairo_pdf)
```
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
   theme_bw() +
    ...
    theme(legend.position="right", 
          ...
          axis.title.x=element_blank(),
          legend.title=element_blank())
#ggsave("./images/sentential_subj.pdf",height=2.8,width=10, device = cairo_pdf)
```
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
   theme_bw() +
    ...
    theme(legend.position="right", 
          ...
          axis.title.x=element_blank(),
          legend.title=element_blank())
#ggsave("./images/subj.pdf",height=2.8,width=10, device = cairo_pdf)
```
...
ggplot(aes(x=island, y=m, ymin=lower, ymax=upper, fill=gap)) +
    ...
    theme(legend.position="right", 
          ...
          axis.title.x=element_blank(),
          legend.title=element_blank())
#ggsave("./images/wh.pdf",height=2.8,width=10, device = cairo_pdf)
```
...
plot_gender = function(df) {
  p = ggplot(df, aes(x=island, y=m, ymin=lower, ymax=upper, fill=lisc)) +
      ...
      theme(legend.position="right", 
            ...
            axis.title.x=element_blank(),
            legend.title=element_blank())
    ggsave(p, filename=paste("./images/gendcheck", unique(df$test), ".pdf", sep=""),height=2.8,width=10, device = cairo_pdf)
  return(df)
}
...
REGION_EXEMPLARS = c("I know", "wh/that", "our mother said", "that", "your friend", "threw", "the plastic", "into the trash can")
NUM_REGIONS = length(REGION_ORDER)
